...
exports.CreateContactDto = exports.CONTACT_TYPES = void 0;
...
__decorate([
    (0, class_transformer_1.Transform)(({ value }) => typeof value === 'string' ? value.trim() : (value ?? 'inquiry')),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsIn)(exports.CONTACT_TYPES),
    __metadata("design:type", String)
