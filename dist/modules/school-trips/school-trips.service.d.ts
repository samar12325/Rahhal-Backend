...
import { SendAllParentApprovalsDto } from './dto/upload-parent-approvals.dto';
...
export declare class SchoolTripsService {
    ...
    uploadParentApprovalsFile(file: Express.Multer.File | undefined, tripId: number, currentUser?: SchoolTripsCurrentUser): Promise<{
        valid: boolean;
        rows: {
            rowNumber: number;
            studentName: string;
    ...
    sendAllParentApprovals(dto: SendAllParentApprovalsDto, currentUser?: SchoolTripsCurrentUser): Promise<{
        results: {
            rowNumber: number;
            email: string;
            status: "sent" | "failed";
    ...
    getPreparation(tripId: number, currentUser?: SchoolTripsCurrentUser): Promise<{
        trip: {
            id: string;
            title: string;
    ...
    updateStudentAttendance(tripId: number, approvalId: number, dto: UpdateStudentAttendanceDto, currentUser?: SchoolTripsCurrentUser): Promise<{
        trip: {
            id: string;
            title: string;
            destinationName: string;
    ...
    sendTrackingLinks(tripId: number, currentUser?: SchoolTripsCurrentUser): Promise<{
        sent: number;
        failed: number;
        skipped: number;
    }>;
    updateTripLiveStatus(tripId: number, dto: UpdateSchoolTripLiveStatusDto, currentUser?: SchoolTripsCurrentUser): Promise<{
        trip: {
            id: string;
            title: string;
            destinationName: string;
    ...
    private createUniqueTrackingToken;
    private getFrontendUrl;
    private buildApprovalLink;
    private buildAbsoluteApprovalLink;
    private buildTrackingLink;
    private buildAbsoluteTrackingLink;
    private toIsoOrNull;
    private getSupervisorName;
    private normalizeCellValue;
    private normalizePhoneValue;
    private normalizeEmailValue;
    private buildUploadColumnLookup;
    private parseParentApprovalFile;
    private validateParentApprovalRows;
    private getPreviouslySentEmails;
    private ensureApprovalEmailWasNotSent;
    private createParentApprovalRecord;
    private sendApprovalEmailAndPersistStatus;
    private dispatchParentApproval;
    private sendParentApprovalEmail;
    private sendTrackingLinkEmail;
